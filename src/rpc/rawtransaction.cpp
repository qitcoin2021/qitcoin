...
static UniValue getrawtransaction(const JSONRPCRequest& request)
{
    RPCHelpMan{
            ...
            "    \"from\": \"xxxx\",                (string) Pledge loan address. Only exist for point sender\n"
            "    \"to\": \"xxxx\"                   (string) Pledge loadebitn address. Only exist for point receiver\n"
            "  },\n"
                ...
                "it is not stored in the wallet or transmitted to the network.\n",
                {
                    ...
                    {"outputs", RPCArg::Type::ARR, RPCArg::Optional::NO, "a json array with outputs (key-value pairs), where none of the keys are duplicated.\n"
                            ...
                            "                             accepted as second parameter.",
                        {
                            ...
                            {"", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED, "",
                                {
                                    {"data", RPCArg::Type::STR_HEX, RPCArg::Optional::NO, "A key-value pair. The key must be \"data\", the value is hex-encoded data. Start with lodash(_) for raw data"},
                                },
                                },
                        },
                        },
